...
3. MySQL Shell has also a command mode, where is possible to create and manage clusters, execute dump and loads, and much more. Command mode can be in python (\\py) or javascript (\\js).
    We explore how they works later on, for the moment just note how the prompt change accordingly to the select mode
...
4. To exit from MySQL Shell type “\q” or “\exit”
...
## Task 3: MySQL Connection with `mysql_config_editor`
